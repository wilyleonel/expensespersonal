import {
  expenses_default
} from "/build/_shared/chunk-2KTJ3N4U.js";
import {
  Button_default,
  InputText_default,
  useForm
...
var Home = () => {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    import_axios2.default.get(`${URL()}/users/${userId2}`, tokenConfig_default(token)).then((_res) => {
      ...
      console.log(...oo_oo(`d166f68a_0`, err));
    });
  }, [userId, token]);
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "relative h-screen w-full bg-primary-color lg:bg-primary-color ", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex  justify-center h-full w-full p-4 text-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h2", { className: "w-full font-bold text-week text-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "h-full", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(motion.div, { className: "py-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Form, { action: "/auth/logout", method: "post", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            Button_default,
            {
              iconName: "Logout",
              type: "submit",
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex justify-center items-center p-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            Button_default,
            {
              text: "Add",
              type: "button",
...
//# sourceMappingURL=/build/routes/home-DS4MCHIS.js.map
