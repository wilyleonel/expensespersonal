...
var Login = () => {
  ...
  const onSubmit = () => {
    import_axios2.default.post(`http://localhost:8000/auth/login`, form).catch((error) => {
      console.log(...oo_oo(`232288c5_0`, setResErrors(error.response.data)));
    });
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative h-screen w-full bg-menu-color lg:bg-primary-color", children: [
...
//# sourceMappingURL=/build/routes/auth/login-ICIF4DUL.js.map
